...
public class PrincipalEtapa3 {
	public static void main(String[] args) {
		...
		//System.out.println("Digite um valor para o tamanho máximo da lista estática:");
		//int maxSize = sc.nextInt();
		

		//StaticList<Object> listaEstatica = new StaticList<>(maxSize);
		
		//listaEstática.contaElementos()
		
		//chama método checkBrackets(Stack<Character> s1):
